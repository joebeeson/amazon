<?php
	...
	App::import('Component', 'Amazon.Amazon');

	/**
	 * AmazonComponentTest
	 *
	 * Unit test case for the `AmazonComponent` object.
	 *
	...
	class AmazonComponentTest extends CakeTestCase {
		...
		public function startTest() {
			$this->Amazon = new AmazonComponentProxy;
		}
		...
		public function testInitialize() {
			...
			// Make sure we don't already have this class available
			$this->assertFalse(class_exists('CFRuntime'));
			...
			$this->assertTrue($this->Amazon->_settings['testing']);
	...
	/**
	 * AmazonComponentProxy
	 *
	 * Extends the `AmazonComponent` to provide access to protected and private
	 * methods and member variables.
	 *
	 * @author Joe Beeson <jbeeson@gmail.com>
	 */
	class AmazonComponentProxy extends AmazonComponent {
